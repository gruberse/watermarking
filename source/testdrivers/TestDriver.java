...
public class TestDriver {
	...
	public static void main(String[] args) {
		...
		DataService.getDataset(1, "files/request1.json", 1, "DexG5MobRec_SM64305440", "cbg", "mmol/L", LocalDate.of(2017, 2, 4),LocalDate.of(2017, 2, 4));
		DataService.getDataset(1, "files/request2.json", 3, 100, "cbg", "mmol/L", LocalDate.of(2015, 12, 30), LocalDate.of(2016, 8, 7));
