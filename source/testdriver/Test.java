...
public class Test {
	...
	private static void testcase_1_01() {
		EnvironmentSetup.resetDatabase();
		EnvironmentSetup.resetFiles();
		EnvironmentSetup.startLogging("testcase_1_01.txt");
	...
	private static void testcase_2_01() {
		EnvironmentSetup.resetDatabase();
		EnvironmentSetup.resetFiles();
		EnvironmentSetup.setUsabilityConstraint(0.5, 256, 10);
		EnvironmentSetup.startLogging("testcase_2_01.txt");

		DataGenerator.generateDataset("generated_dataset.json", 10, "2019-01-01", "2019-03-30");
		...
		DataDetectiveSimulator.detectLeakage("requested_dataset_1_deletion.json",
				"requested_dataset_1_deletion_report.txt", 0.8, 0.8);

		AttackGenerator.performRandomDistortionAttack("requested_dataset_1.json", "requested_dataset_1_random.json",
				0.25);
		DataDetectiveSimulator.detectLeakage("requested_dataset_1_random.json", "requested_dataset_1_random_report.txt",
				0.8, 0.8);

		AttackGenerator.performRoundingDistortionAttack("requested_dataset_1.json", "requested_dataset_1_rounding.json",
				2);
		DataDetectiveSimulator.detectLeakage("requested_dataset_1_rounding.json",
				"requested_dataset_1_rounding_report.txt", 0.8, 0.8);
		...
		AttackGenerator.performMeanCollusionAttack(
				Arrays.asList("requested_dataset_1.json", "requested_dataset_2.json"), "collusion_dataset_1.json");
		DataDetectiveSimulator.detectLeakage("collusion_dataset_1.json", "collusion_dataset_1_report.txt", 0.8, 0.8);
